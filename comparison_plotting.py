...
for i in range(start,end,step):
	...
	if nOther_res != 0:
		...
		plt.figure(4)
		plot_1d(range(nOther_res),data[other_index[0]:],'k','Substrate Residue Selections','RMSF','%03d.%03d.%s'%(i,j,system),'sub_rmsf',marker_style='.',yunits='$\AA$',x_lim=(0,nOther_res-1),y_lim=(0,4),plt_title='RMSF of Substrate Residue Selections (Traj %03d - %03d)' %(i,j))
